...
using namespace cv;
using namespace std;
#define FILENAME "/home/exbot/ros_kinect_gazebo/src/turtlemove/scripts/one_pictest/test.png"
    ...
    if (area > 40000) //只画出轮廓大于1000的点
    {
      ...
      if (x > 15 && y > 15 && (x + width + 15) < inImg.size().width &&
        ...
        if (!_file) {
          ...
          imwrite("/home/exbot/ros_kinect_gazebo/src/turtlemove/scripts/one_pictest/test.png",
                  image_roi); //保存截取图片
